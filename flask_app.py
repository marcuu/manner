...
class Recipes(db.Model):
    ...
    dietary = db.Column(JSON)  # Assuming JSON type supported, check your database specifics
...
def get_recipes():
    ...
    return jsonify([{ 'MealName': recipe.MealName, 'mealType': recipe.mealType, 'cuisine': recipe.cuisine, 'dietary': recipe.dietary, 'characteristics': recipe.characteristics } for recipe in recipes])
